...
public class createDatabase {
    ...
    static void initDatabase (String filePath) {
        ...
        */
        ...
        UtilsSQLite.queryUpdate(conn, "INSERT INTO user (name,password) VALUES (\"Enric\",\"1234\");");
        UtilsSQLite.queryUpdate(conn, "INSERT INTO user (name,password) VALUES (\"Lluis\",\"4321\");");
